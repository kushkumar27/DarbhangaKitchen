	...
	render(){
		...
		return(
			<div className="container">
				<SearchMenu tag="southindian" className="search-toogle" changeState={this.changeState}/>
				<MenuItem tag="south-indian" type={this.state.type} search={this.state.search}/>
				<ViewThali/>
			</div>
		);
	}
